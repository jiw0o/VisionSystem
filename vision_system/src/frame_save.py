...
class Pintrigger :
    ...
    def read_image(self, sub1, sub2, sub3) :
        ...
        f1 = "/home/visionsystem/catkin_ws/data/cam1/cam1-" + str(self.cnt) + ".png"
        f2 = "/home/visionsystem/catkin_ws/data/cam2/cam2-" + str(self.cnt) + ".png"
        f3 = "/home/visionsystem/catkin_ws/data/cam3/cam3-" + str(self.cnt) + ".png"
    ...
    def read_tester(self, sub1, sub2, sub3) :
        ...
        f1 = "/home/visionsystem/catkin_ws/data/cam1-" + str(self.cnt) + ".png"
        f2 = "/home/visionsystem/catkin_ws/data/cam2-" + str(self.cnt) + ".png"
        f3 = "/home/visionsystem/catkin_ws/data/cam3-" + str(self.cnt) + ".png"
        cv2.imwrite(f1, img1)
        cv2.imwrite(f2, img2)
        cv2.imwrite(f3, img3)
        print(self.cnt)
